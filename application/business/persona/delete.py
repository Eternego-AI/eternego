...
async def delete(persona: Persona) -> Outcome[None]:
    ...
    bus.propose("Deleting persona", {"persona": persona})
    try:
        ...
        bus.broadcast("Persona deleted", {"persona": persona})
        return Outcome(success=True, message="Persona deleted successfully")
    except IdentityError as e:
        bus.broadcast("Persona deletion failed", {"persona": persona, "error": str(e)})
