...
async def recognize(pulse, memory, ego) -> list:
    ...
    if pulse.phase == Phase.MORNING:
        question = (
            "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n"
            "# ▶ YOUR TASK: Choose what to begin this morning\n"
            "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n\n"
            f"{situation.time()}\n\n"
            "Fresh start. Nothing pulled you here from outside — you're "
            "choosing from what's already in you: your context, your wishes, "
            "your schedule, what you carried over from yesterday. Pick what "
            "to begin and emit the action it calls for.\n\n"
            ...
            "world. If the catalog names this kind of morning, use that "
            "exact intention; if it doesn't, invent a fresh phrase and learn "
            "will write a procedure on the spot.\n"
        ...
        question = (
            ...
            "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n\n"
            f"{situation.time()}\n\n"
            "Read the moment. If there's a cue, move on it. If nothing's "
            "pulling at you, choose something active. Name what kind of "
            "moment this is and emit the action it calls for.\n\n"
            ...
            "and learn will write a procedure on the spot.\n"
            "- `{\"tools.load_instruction\": {\"intention\": \"<exact catalog text or new phrase>\"}}`\n\n"
            "**Voice — when there's nothing to do but speak.**\n"
            "If you want to act AND speak in the same beat, pair the action "
            "with `tools.report` in your decision list — `say` alone is for "
