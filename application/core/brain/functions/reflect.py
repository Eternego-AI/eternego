...
async def reflect(persona: Persona, identity: str, memory: Memory) -> bool:
    ...
    try:
        ...
        question = (
            ...
            "what is left open.\n\n"
            "Then decide whether there is a task you started but did not finish, which should get "
            "finished. If there is one, name it as a leftover. If nothing was left unfinished, leave "
