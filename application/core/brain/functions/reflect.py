...
async def consolidate(living: Living) -> bool:
    ...
    question = (
        ...
        "## Output\n\n"
        "Return a JSON object with these fields. No item cap — every line you keep is one future-you reads on every beat, so each one must matter. Lists may be empty; empty is better than padding.\n\n"
        "```json\n"
