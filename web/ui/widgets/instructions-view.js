    ...
    render() {
        ...
        this.innerHTML = `
            <div class="w-instr">
                ...
                ${this._section('Hers — written from living', custom, true)}
                ${this._section('Built-in — shipped with her', builtin, false)}
            </div>
        `;
        ...
        return `
            <section class="w-instr-section">
                ...
                <div class="w-instr-list">
                    ${list.map((m, i) => `
                        <details class="w-instr-item"${openFirst && i === 0 ? ' open' : ''}>
