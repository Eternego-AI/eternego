...
from application.platform import anthropic, openai


def test_chat_calls_anthropic_with_correct_model():
...
def test_read_parses_anthropic_export():
    export = json.dumps([
...
def test_read_parses_openai_export():
    export = json.dumps([
...
def test_read_raises_on_invalid_data():
    try:
