...
def test_md_list_extracts_lines_under_section():
    _setup()
...
def test_md_list_returns_empty_for_missing_section():
    _setup()
    p = paths.home("test-paths")
    p.mkdir(parents=True, exist_ok=True)
    f = p / "test.md"
...
def test_md_list_returns_empty_for_missing_file():
    _setup()
...
def test_delete_entry_removes_matching_line():
    _setup()
    p = paths.home("test-paths")
    p.mkdir(parents=True, exist_ok=True)
    f = p / "entries.md"
...
def test_delete_entry_does_nothing_for_missing_hash():
    _setup()
    p = paths.home("test-paths")
    p.mkdir(parents=True, exist_ok=True)
    f = p / "entries.md"
...
def test_due_destiny_entries_returns_entries_before_time():
    _setup()
...
def test_due_destiny_entries_empty_when_none_due():
    _setup()
    dest = paths.destiny("test-paths")
    dest.mkdir(parents=True, exist_ok=True)
...
def test_save_and_read_destiny_entry():
    _setup()
...
def test_add_history_entry_creates_file():
    _setup()
